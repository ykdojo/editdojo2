...
class Command(BaseCommand):
    ...
    def twitter_checker(self):
        ...
        tweets_in_list = api.list_timeline(owner_screen_name=os.environ['OWNER_SCREEN_NAME'], slug=os.environ['TWITTER_LIST'], include_rts=False,
                                           tweet_mode='Extended')
        ...
        if local == False:
            if schedule == True:
                ...
                job = scheduler.cron(
                    ...
                    func=self.twitter_checker(),  # Function to be queued
            ...
            q.enqueue(self.twitter_checker())
