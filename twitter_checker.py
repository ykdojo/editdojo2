...
def twitter_checker():
    ...
    obj = already_in_twitter.objects.filter(already_in_twitter=False) #looks for all users who are 'False' in the model.
    for i in range(len(obj)):
        user_to_add = obj.values_list('user')[i][0] #get user ID
